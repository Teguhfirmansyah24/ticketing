...
<body class="antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-4">
                <div class="flex items-center gap-2">
                    <span class="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-[10px] font-bold">1</span>
                    <span class="text-[11px] uppercase tracking-wider text-slate-400">Pilih Tiket</span>
                </div>
                <i class="fas fa-chevron-right text-[10px] text-slate-300"></i>
                <div class="flex items-center gap-2">
                    <span class="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-[10px] font-bold">2</span>
                    <span class="text-[11px] uppercase tracking-wider text-slate-400">Informasi Personal</span>
                </div>
                <i class="fas fa-chevron-right text-[10px] text-slate-300"></i>
                <div class="flex items-center gap-2">
                    <span class="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-[10px] font-bold">3</span>
    ...
    <main class="max-w-2xl mx-auto py-10 px-4 space-y-8">
        ...
        <div class="text-center space-y-3">
            <div class="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto border 
        ...
        <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden relative">
            ...
            <div class="absolute top-8 right-8">
                <span class="px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm text-white 
            ...
            <div class="p-8 bg-white">
                @if($order->status !== 'approved')
                    {{-- Muncul hanya jika PENDING --}}
                    <button id="pay-button" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-xl font-bold text-sm uppercase tracking-widest transition-all shadow-lg shadow-blue-100 flex items-center justify-center">
                ...
                @else
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <a href="{{ route('member.tiket.index') }}" class="w-full bg-emerald-500 hover:bg-emerald-600 text-white py-4 rounded-xl text-center font-bold text-sm uppercase tracking-widest transition-all shadow-lg shadow-emerald-100">
                            Lihat Tiket Saya
                        </a>
                    </div>
                @endif
        ...
        <div class="flex items-start gap-3 px-4 text-slate-400">
            ...
            <p class="text-xs leading-relaxed font-medium">
                Dengan menekan tombol <span class="font-bold">"Bayar Sekarang"</span>, pesanan kamu akan dibuat dan kamu perlu menyelesaikan pembayaran dalam waktu
