                    ...
                    <div x-show="open" @click.outside="open = false"
                        ...
                        <div class="px-2 space-y-1">
                            ...
                            <a href="{{route('admin.legal.index')}}"
                                class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold text-slate-600 hover:bg-indigo-50 hover:text-indigo-600 transition-all group">
                                <i class="fas fa-scale-balanced w-5 text-slate-400 group-hover:text-indigo-500"></i>
                            ...
                            <a href="{{route('admin.report.index')}}"
                                class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold text-slate-600 hover:bg-indigo-50 hover:text-indigo-600 transition-all group">
                                <i class="fas fa-chart-line w-5 text-slate-400 group-hover:text-indigo-500"></i>
                                <span>Laporan</span>
                            </a>
                        </div>
